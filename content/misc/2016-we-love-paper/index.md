...
而且dblp整站的数据可以下载为一个[xml文件](https://dblp.org/xml/)，以供进一步挖掘。
...
<figure>
<img alt="@爱可可的读论文建议" src="o/arxiv.jpg" width="640px">
</figure>
...
<!--
## 软件工程学科知识体系
软件工程学科知识体系 Software Engineering Body of Knowledge, SWEBoK, ISO/IEC TR 19759:2005([wiki](https://en.wikipedia.org/wiki/Software_Engineering_Body_of_Knowledge), [SWEBoK@IEEE Computer](https://www.computer.org/education/bodies-of-knowledge/software-engineering), [PDF 全文](o/SWEBoKv3.pdf))。

+ [The Morning Paper (已停更)](https://blog.acolyer.org)
...
<p class="kai s">2023-05-10：更新部分文字。<br/>
