...
<p>作者似乎是一位考古学家，对计算机科学只有短暂的兴趣。这是不幸的；尽管大多数计算机科学家对他描述的晦涩古老的Paxos文明没什么兴趣，但它的立法体系是异步环境中实现分布计算机系统的绝佳模型。事实上，Paxos岛人对其协议所做的一些改进似乎尚未被系统文献得知。</p>
...
<p>Paxos的官方记录声称立法员和信使非常诚实，并严格遵守议会协议。大多数学者认为这是宣传，旨在将Paxos描绘成道德上优于其东方邻居。不诚实虽然少见，但毫无疑问发生过。然而，因为它从未在官方文件中提及，我们对议会如何应对不诚实的立法员或信使知之甚少。第3.3.5节将讨论已发现的证据。</p>
...
<li><a href="/dist/1985-flp.html" target="_blank">Fischer, M. J., Lynch, N. A., and Paterson, M. S. 1985. Impossibility of Distributed Consensus with One Faulty Process.</a> <i>J. ACM</i> 32, 1 (Jan.), 374-382.</li>
...
<li><a href="/time/1978-lamport-cn/" target="_blank">Lamport, L. 1978. Time, Clocks, and the Ordering of Events in a Distributed System.</a> <i>Commun. ACM</i> 21, 7, 558-565.</li>
...
<h1>附录：Synod协议一致性的证明</h1>
<h2>A1. 基本协议</h2>
<p>略，请见原文</p>
<h2>A2. 一致性的证明</h2>
<p>略，请见原文</p>

[**附录原文(pdf)**](paxos-appendix.pdf)
